...
#Get the evoked stc and then morph it into fsaverage
...
seed_idx = np.searchsorted(stc_morph.vertno[0], seed_vertno)  # index in original stc
# Generate index parameter for seed-based connectivity analysis
n_sources = stc_morph.data.shape[0]
...
coh_new=coh.squeeze()#n_con*times
...
coh_stc_morph = mne.morph_data(subject, 'fsaverage', coh_stc, 5, smooth=5)
coh_stc_morph.save(subject_path+'/ROI_fsaverage'+subject+'_' +trigger, ftype='stc')
